...
DFTFlow는 PySCF와 ASE를 기반으로 한 로컬 워크스테이션용 계산 워크플로우 도구입니다. 최적화, 단일점, 진동수, IRC, 스캔을 일관된 로그/메타데이터로 실행합니다.
...
- 기본 실행 디렉터리: `~/DFTFlow/runs/YYYY-MM-DD_HHMMSS/`
- `DFTFLOW_BASE_DIR` 환경 변수로 기본 경로를 변경할 수 있습니다.
